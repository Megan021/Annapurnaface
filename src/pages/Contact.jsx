...
const Contact = () => {
  return (
    <>
     <ContactBanner />
     <div className='flex flex-col lg:flex-row gap-12 md:w-[74%] px-4 md:px-0 mx-auto py-20'>
          <div className='lg:w-[60%]'>
               <img src="/images/ForContact/contact.jpg" alt="" className='h-full object-cover w-full' />
          </div>

          <div className='lg:w-[40%] text-center py-4'>
     ...
     <div className='md:flex md:w-[74%] mx-auto'>
